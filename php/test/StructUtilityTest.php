...
// OsuBeatmap SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OsuBeatmapOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OsuBeatmapOmni::structfix($now, Struct::undef()))
                        !== json_encode(OsuBeatmapOmni::structfix($val, Struct::undef()))) {
