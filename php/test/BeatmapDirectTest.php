...
class BeatmapDirectTest extends TestCase
{
    public function test_direct_load_beatmap(): void
    {
        $setup = beatmap_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-beatmap", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
