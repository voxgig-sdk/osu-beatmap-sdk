...
class DownloadEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OSUBEATMAP_TEST_DOWNLOAD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function download_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OSUBEATMAP_TEST_DOWNLOAD_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["OSUBEATMAP_TEST_DOWNLOAD_ENTID"]);
