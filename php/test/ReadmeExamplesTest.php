...
// OsuBeatmap SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OsuBeatmapSDK::test)
...
{
    private const SDK_CLASS = 'OsuBeatmapSDK';
    ...
    private const SDK_BASE = 'osubeatmap_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../osubeatmap_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
