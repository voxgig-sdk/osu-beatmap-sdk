...
```php
try {
    // load() returns the ENTITY — call data_get() for the Beatmap record (throws on error).
...
```
php/
├── osubeatmap_sdk.php          -- Main SDK class
...
The main class (`osubeatmap_sdk.php`) exports the SDK class
