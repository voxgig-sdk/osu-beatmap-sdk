...
The PHP SDK for the OsuBeatmap API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Beatmap(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->OsuBeatmap(null)->load(
    ["id" => "test01"], null
);
