...
// OsuBeatmap SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OsuBeatmapTransformResponse
{
    public static function call(OsuBeatmapContext $ctx): mixed
    {
        ...
        $transform = OsuBeatmapHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
