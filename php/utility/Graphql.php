...
// OsuBeatmap SDK utility: graphql
//
...
class OsuBeatmapGraphql
{
    ...
    // equivalent.
    public static function body(OsuBeatmapContext $ctx): mixed
    {
    ...
    public static function errors(OsuBeatmapContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
