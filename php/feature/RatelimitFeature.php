...
// OsuBeatmap SDK ratelimit feature
...
class OsuBeatmapRatelimitFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _acquire(OsuBeatmapContext $ctx): void
    {
    ...
    private function _track(OsuBeatmapContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
