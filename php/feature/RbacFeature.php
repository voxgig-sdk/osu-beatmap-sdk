...
class OsuBeatmapRbacFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _required(OsuBeatmapContext $ctx): ?string
    {
    ...
    private function _reject(OsuBeatmapContext $ctx, string $required): void
    {
    ...
    private function _track(OsuBeatmapContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
