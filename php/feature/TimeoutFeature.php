...
// OsuBeatmap SDK timeout feature
...
class OsuBeatmapTimeoutFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _with_timeout(OsuBeatmapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OsuBeatmapContext $_ctx, float $ms): void
    {
        $client = $this->client;
