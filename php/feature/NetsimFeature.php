...
class OsuBeatmapNetsimFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _simulate(OsuBeatmapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OsuBeatmapContext $ctx, array $applied): void
    {
        $client = $this->client;
