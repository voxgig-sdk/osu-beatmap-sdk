...
class OsuBeatmapSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = OsuBeatmapHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = OsuBeatmapHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!OsuBeatmapFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, OsuBeatmapFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return OsuBeatmapUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = OsuBeatmapHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = OsuBeatmapHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = OsuBeatmapHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new OsuBeatmapError($op . "_allow",
                "OsuBeatmapSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = OsuBeatmapHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new OsuBeatmapError("graphql_error",
                "OsuBeatmapSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Beatmap($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_beatmap === null) {
                $this->_beatmap = new BeatmapEntity($this, null);
            }
            return $this->_beatmap;
        }
        return new BeatmapEntity($this, $data);
    }
