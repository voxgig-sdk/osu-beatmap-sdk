...
AQL-driven CLI and REPL for the OsuBeatmap SDK. Positional arguments are
...
./osu-beatmap-cli list beatmap
./osu-beatmap-cli load 1 beatmap
./osu-beatmap-cli load '{id:1}' beatmap
