...
func registerSDKWords(r *eng.Registry, client *sdk.OsuBeatmapSDK) {
...
func runOp(client *sdk.OsuBeatmapSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
