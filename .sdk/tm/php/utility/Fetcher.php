...
// OsuBeatmap SDK utility: fetcher

class OsuBeatmapFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OsuBeatmapSDK/1.0)';
    ...
    public static function call(OsuBeatmapContext $ctx, string $fullurl, array $fetchdef): array
    {
