...
{
    private static function utility(): OsuBeatmapUtility
    {
        return new OsuBeatmapUtility();
    }
    ...
    private static function ctx(array $over = []): OsuBeatmapContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OsuBeatmapContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OsuBeatmapOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OsuBeatmapError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OsuBeatmapOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OsuBeatmapMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OsuBeatmapOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OsuBeatmapMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OsuBeatmapOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OsuBeatmapMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OsuBeatmapSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OsuBeatmapMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OsuBeatmapResponse([]),
            'result' => new OsuBeatmapResult([]),
        ]);
        [, $err] = OsuBeatmapMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec([]),
            'response' => null,
            'result' => new OsuBeatmapResult([]),
        ]);
        [, $err] = OsuBeatmapMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec(['step' => 's']),
            'response' => new OsuBeatmapResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OsuBeatmapResult([]),
        ]);
        [, $err] = OsuBeatmapMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec(['step' => 's']),
            'response' => new OsuBeatmapResponse(self::resp(200, ['v' => 1])),
            'result' => new OsuBeatmapResult([]),
        ]);
        [, $err] = OsuBeatmapMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec(['step' => 's']),
            'response' => new OsuBeatmapResponse(self::resp(200, ['v' => 2])),
            'result' => new OsuBeatmapResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OsuBeatmapMakeResponse::call($ctx);
    ...
    {
        $preset = new OsuBeatmapResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec([]),
            'response' => new OsuBeatmapResponse([]),
            'result' => new OsuBeatmapResult([]),
        ...
        [$got, $err] = OsuBeatmapMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OsuBeatmapResult([])]);
        [, $err] = OsuBeatmapMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OsuBeatmapSpec([]), 'result' => null]);
        [, $err] = OsuBeatmapMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OsuBeatmapSpec(['step' => 's']),
            'result' => new OsuBeatmapResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OsuBeatmapOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OsuBeatmapMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OsuBeatmapSpec(['step' => 's']),
            'result' => new OsuBeatmapResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OsuBeatmapOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OsuBeatmapMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OsuBeatmapResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OsuBeatmapSpec([]),
            'result' => new OsuBeatmapResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OsuBeatmapMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OsuBeatmapMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OsuBeatmapError('boom', 'boom');
        $utility->fetcher = function (OsuBeatmapContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OsuBeatmapSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OsuBeatmapMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OsuBeatmapContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OsuBeatmapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OsuBeatmapResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OsuBeatmapMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OsuBeatmapContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OsuBeatmapSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OsuBeatmapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OsuBeatmapResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OsuBeatmapSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OsuBeatmapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OsuBeatmapMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OsuBeatmapMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OsuBeatmapResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OsuBeatmapDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OsuBeatmapResult(['ok' => false])]);
        $this->expectException(OsuBeatmapError::class);
        OsuBeatmapDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OsuBeatmapResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OsuBeatmapMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OsuBeatmapMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OsuBeatmapBaseFeature();
        $b = new OsuBeatmapBaseFeature();
        OsuBeatmapFeatureAdd::call($ctx, $a);
        OsuBeatmapFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OsuBeatmapBaseFeature
    {
        $f = new OsuBeatmapBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OsuBeatmapFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OsuBeatmapContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OsuBeatmapSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OsuBeatmapPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OsuBeatmapPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OsuBeatmapResponse(['headers' => null]),
            'result' => new OsuBeatmapResult([]),
        ]);
        OsuBeatmapResultHeaders::call($ctx);
