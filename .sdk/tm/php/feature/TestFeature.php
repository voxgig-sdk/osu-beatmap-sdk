...
class OsuBeatmapTestFeature extends OsuBeatmapBaseFeature
{
    ...
    public function init(OsuBeatmapContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OsuBeatmapContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = OsuBeatmapParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OsuBeatmapContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OsuBeatmapContext $ctx, $op, $args): array
    {
