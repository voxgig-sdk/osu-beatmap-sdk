...
// OsuBeatmap SDK clienttrack feature
...
class OsuBeatmapClienttrackFeature extends OsuBeatmapBaseFeature
{
    ...
    public function PostConstruct(OsuBeatmapContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OsuBeatmap-SDK';
