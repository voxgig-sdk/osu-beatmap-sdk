...
class OsuBeatmapCacheFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _through(OsuBeatmapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
