...
// OsuBeatmap SDK streaming feature
...
class OsuBeatmapStreamingFeature extends OsuBeatmapBaseFeature
{
    ...
    private function _iterate(OsuBeatmapResult $result): \Generator
    {
    ...
    private function _streamable(OsuBeatmapContext $ctx): bool
    {
