...
class OsuBeatmapProxyFeature extends OsuBeatmapBaseFeature
{
    ...
    public function init(OsuBeatmapContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OsuBeatmapContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
