# OsuBeatmap SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, OsuBeatmapError):
        errmsg = err.msg
    ...
    msg = "OsuBeatmapSDK: " + opname + ": " + errmsg
    ...
    sdk_err = OsuBeatmapError("", msg, ctx)
