...
from projectname_sdk.core.control import OsuBeatmapControl
...
class OsuBeatmapContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OsuBeatmapSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OsuBeatmapResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OsuBeatmapResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OsuBeatmapError(code, msg, self)
