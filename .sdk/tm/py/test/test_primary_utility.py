...
from projectname_sdk import OsuBeatmapSDK
from projectname_sdk.core.spec import OsuBeatmapSpec
from projectname_sdk.core.result import OsuBeatmapResult
from projectname_sdk.core.response import OsuBeatmapResponse
from projectname_sdk.core.operation import OsuBeatmapOperation
from projectname_sdk.core.error import OsuBeatmapError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import OsuBeatmapBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return OsuBeatmapError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = OsuBeatmapSDK.test(None, None)
        ...
        class TestInitFeature(OsuBeatmapBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(OsuBeatmapBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = OsuBeatmapSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = OsuBeatmapSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = OsuBeatmapSDK.test(None, setup_opts)
