...
|---|---|---|
| `ts/` | @voxgig-sdk/osu-beatmap-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/osu-beatmap-sdk \
      --repository voxgig-sdk/osu-beatmap-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/osu-beatmap-sdk` shows it, and
`npm trust revoke @voxgig-sdk/osu-beatmap-sdk --id=<id>` removes it.
