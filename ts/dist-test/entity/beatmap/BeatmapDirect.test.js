...
(0, node_test_1.describe)('BeatmapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OsuBeatmapSDK({
    ...
    (0, node_test_1.test)('direct-load-beatmap', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-beatmap', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OsuBeatmapSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['OSU_BEATMAP_TEST_BEATMAP_ENTID'];
    ...
    const client = new __1.OsuBeatmapSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BeatmapDirect.test.js.map