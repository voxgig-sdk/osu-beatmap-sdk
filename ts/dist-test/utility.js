...
function envOverride(m) {
    if ('TRUE' === process.env.OSU_BEATMAP_TEST_LIVE ||
        'TRUE' === process.env.OSU_BEATMAP_TEST_OVERRIDE) {
    ...
    m.OSU_BEATMAP_TEST_EXPLAIN = process.env.OSU_BEATMAP_TEST_EXPLAIN || m.OSU_BEATMAP_TEST_EXPLAIN;
    return m;
}
