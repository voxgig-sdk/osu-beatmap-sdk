...
describe('BeatmapDirect', async () => {
  ...
  test('direct-load-beatmap', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-beatmap', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['OSU_BEATMAP_TEST_BEATMAP_ENTID']
