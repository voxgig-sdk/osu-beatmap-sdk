...
The TypeScript SDK for the OsuBeatmap API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new OsuBeatmapSDK({ apikey: '...' })
