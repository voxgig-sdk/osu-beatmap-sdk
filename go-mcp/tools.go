...
type Args struct {
	Entity string         `json:"entity" jsonschema:"beatmap | download | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OsuBeatmapSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "osu-beatmap_list",
		Description: "List records from OsuBeatmap. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "osu-beatmap_load",
		Description: "Load a single record from OsuBeatmap. " +
...
func runOp(client *sdk.OsuBeatmapSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OsuBeatmapSDK, name string) (sdk.OsuBeatmapEntity, error) {
	switch strings.ToLower(name) {
	case "beatmap":
		return client.Beatmap(nil), nil
	case "download":
