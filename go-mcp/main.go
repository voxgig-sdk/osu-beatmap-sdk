// Command OsuBeatmap-mcp is an MCP server exposing the OsuBeatmap
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OsuBeatmap_list  — list records of an entity
//	OsuBeatmap_load  — load a single record of an entity
//
