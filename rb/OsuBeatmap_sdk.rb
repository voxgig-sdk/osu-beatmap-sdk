...
require_relative 'OsuBeatmap_types'
...
class OsuBeatmapSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = OsuBeatmapHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = OsuBeatmapHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, OsuBeatmapFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    OsuBeatmapUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = OsuBeatmapHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = OsuBeatmapHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = OsuBeatmapHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = OsuBeatmapHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = OsuBeatmapError.new(
        "graphql_error", "OsuBeatmapSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
