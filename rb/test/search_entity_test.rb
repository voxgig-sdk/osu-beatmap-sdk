...
class SearchEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = OsuBeatmapSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OSUBEATMAP_TEST_SEARCH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def search_basic_setup(extra)
  ...
  entid_env_raw = ENV["OSUBEATMAP_TEST_SEARCH_ENTID"]
