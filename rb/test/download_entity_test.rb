...
class DownloadEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set OSU_BEATMAP_TEST_DOWNLOAD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def download_basic_setup(extra)
  ...
  entid_env_raw = ENV["OSU_BEATMAP_TEST_DOWNLOAD_ENTID"]
