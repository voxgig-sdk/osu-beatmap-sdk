# OsuBeatmap SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OsuBeatmapSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OsuBeatmapSDK(...) and OsuBeatmapSDK.test(...) become
#      OsuBeatmapSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "osubeatmap_sdk"
_SDK_CLASS = "OsuBeatmapSDK"
