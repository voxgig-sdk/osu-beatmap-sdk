...
class OsuBeatmapTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OsuBeatmapTestRunner.getenv("OSUBEATMAP_TEST_LIVE")
        override = OsuBeatmapTestRunner.getenv("OSUBEATMAP_TEST_OVERRIDE")
        ...
        explain = OsuBeatmapTestRunner.getenv("OSUBEATMAP_TEST_EXPLAIN")
