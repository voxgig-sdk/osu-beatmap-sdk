...
from osubeatmap_sdk.utility import register

# Load features
from osubeatmap_sdk.feature.base_feature import OsuBeatmapBaseFeature
from osubeatmap_sdk.features import _has_feature, _make_feature
...
class OsuBeatmapSDK:
    ...
    def get_utility(self):
        return OsuBeatmapUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OsuBeatmapSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def Beatmap(self, data=None) -> "BeatmapEntity":
        """Entity factory: client.Beatmap().list() / client.Beatmap().load({"id": ...})."""
        from osubeatmap_sdk.entity.beatmap_entity import BeatmapEntity
        return BeatmapEntity(self, data)


    def Download(self, data=None) -> "DownloadEntity":
        """Entity factory: client.Download().list() / client.Download().load({"id": ...})."""
        from osubeatmap_sdk.entity.download_entity import DownloadEntity
        return DownloadEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from osubeatmap_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "OsuBeatmapSDK":
        if sdkopts is None:
            sdkopts = {}
