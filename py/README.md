# OsuBeatmap Python SDK



The Python SDK for the OsuBeatmap API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Beatmap()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/osu-beatmap-sdk/releases)) or
...
| --- | --- | --- |
| `approved_date` | `str` | Date when beatmap was approved/ranked |
| `ar` | `float` | Approach rate |
| `artist` | `str` | Song artist |
| `beatmapset_id` | `int` | Beatmap set ID |
| `bpm` | `float` | Beats per minute |
| `creator` | `str` | Beatmap creator username |
...
| `status` | `str` | Beatmap status (ranked, qualified, loved, etc.) |
...
```
py/
├── osubeatmap_sdk.py         -- Main SDK module
