...
local OsuBeatmapSDK = {}
OsuBeatmapSDK.__index = OsuBeatmapSDK
...
OsuBeatmapSDK._make_feature = _make_feature


function OsuBeatmapSDK.new(options)
  local self = setmetatable({}, OsuBeatmapSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OsuBeatmapSDK:options_map()
...
function OsuBeatmapSDK:get_utility()
  return Utility.copy(self._utility)
end


function OsuBeatmapSDK:get_root_ctx()
  return self._rootctx
end


function OsuBeatmapSDK:prepare(fetchargs)
...
function OsuBeatmapSDK:direct(fetchargs)
...
-- by passing it.
function OsuBeatmapSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OsuBeatmapSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OsuBeatmapSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OsuBeatmapSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OsuBeatmapSDK.new(sdkopts)
  sdk.mode = "test"
