...
describe("BeatmapDirect", function()
  it("should direct-load-beatmap", function()
    local setup = beatmap_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-beatmap", setup.live and "live" or "unit")
...
function beatmap_direct_setup(mockres)
