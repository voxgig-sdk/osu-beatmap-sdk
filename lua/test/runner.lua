...
function runner.env_override(m)
  local live = runner.getenv("OSU_BEATMAP_TEST_LIVE")
  local override = runner.getenv("OSU_BEATMAP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OSU_BEATMAP_TEST_EXPLAIN")
