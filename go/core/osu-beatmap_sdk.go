...
func (sdk *OsuBeatmapSDK) OptionsMap() map[string]any {
...
func (sdk *OsuBeatmapSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OsuBeatmapSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OsuBeatmapSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OsuBeatmapSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OsuBeatmapSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OsuBeatmapSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OsuBeatmapSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OsuBeatmapSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OsuBeatmapSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OsuBeatmapSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
