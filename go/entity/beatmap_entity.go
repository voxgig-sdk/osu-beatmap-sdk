...
func NewBeatmapEntity(client *core.OsuBeatmapSDK, entopts map[string]any) *BeatmapEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BeatmapEntity) GetName() string { return e.name }
...
func (e *BeatmapEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BeatmapEntity) Deleted() bool {
	return e.deleted
}


func (e *BeatmapEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBeatmapEntity(e.client, opts)
}

func (e *BeatmapEntity) Data(args ...any) any {
...
func (e *BeatmapEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Beatmap; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BeatmapEntity) DataTyped(data ...Beatmap) Beatmap {
	if len(data) > 0 {
		return typedFrom[Beatmap](e.Data(asMap(data[0])))
	}
	return typedFrom[Beatmap](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Beatmap (all fields
// optional at the wire level).
func (e *BeatmapEntity) MatchTyped(match ...Beatmap) Beatmap {
	if len(match) > 0 {
		return typedFrom[Beatmap](e.Match(asMap(match[0])))
	}
	return typedFrom[Beatmap](e.Match())
}
...
func (e *BeatmapEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BeatmapEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BeatmapLoadMatch and returns an Beatmap. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BeatmapEntity) LoadTyped(reqmatch BeatmapLoadMatch, ctrl map[string]any) (Beatmap, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Beatmap{}, err
	}
	return typedFrom[Beatmap](res), nil
}



func (e *BeatmapEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BeatmapEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BeatmapEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BeatmapEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BeatmapEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
