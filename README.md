...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/osu-beatmap` | `npm install @voxgig-sdk/osu-beatmap` |
| Python | `voxgig-sdk-osu-beatmap` | `pip install voxgig-sdk-osu-beatmap` |
| PHP | `voxgig-sdk/osu-beatmap` | `composer require voxgig-sdk/osu-beatmap` |
| Golang | `github.com/voxgig-sdk/osu-beatmap-sdk/go` | `go get github.com/voxgig-sdk/osu-beatmap-sdk/go` |
| Ruby | `voxgig-sdk-osu-beatmap` | `gem install voxgig-sdk-osu-beatmap` |
| Lua | `voxgig-sdk-osu-beatmap` | `luarocks install voxgig-sdk-osu-beatmap` |
