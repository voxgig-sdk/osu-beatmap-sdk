...
Search, discover, and download osu!

Learn more about osu! beatmap API at [osu.direct](https://osu.direct).

This is an unofficial SDK for the osu! beatmap public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Beatmap, Download and Search — that you
...
| Ruby | `voxgig-sdk-osu-beatmap` | publish pending — [install from git tag](https://github.com/voxgig-sdk/osu-beatmap-sdk/releases) |
| Lua | `voxgig-sdk-osu-beatmap` | publish pending — [install from git tag](https://github.com/voxgig-sdk/osu-beatmap-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/osu-beatmap-sdk/go-cli` | `go install github.com/voxgig-sdk/osu-beatmap-sdk/go-cli/cmd/osu-beatmap@latest` |
| Go MCP server | `github.com/voxgig-sdk/osu-beatmap-sdk/go-mcp` | `go get github.com/voxgig-sdk/osu-beatmap-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Beatmap** | The Beatmap entity (load). | `/beatmaps/{id}` |
| **Download** | The Download entity (load). | `/download/{id}` |
